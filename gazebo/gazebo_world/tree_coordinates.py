...
# origin_distance = 5
# num_trees = 15
# tree_box_size = 2  # side length of square boundary around each tree

# # ---------------- OPTIONS ----------------
# use_random_positions = False  # Set False to manually specify positions
...
#         if abs(x) >= origin_distance or abs(y) >= origin_distance
#     ]
#     random.shuffle(possible_positions)
#     selected_positions = possible_positions[:num_trees]
# else:
#     # Manually specify positions here
#     selected_positions = [(-2, 3)]

# # ---------------- ROTATE 90° ABOUT Z ----------------
# rotated_positions = [(-y, x) for (x, y) in selected_positions]
...
#     # Tree marker
#     ax.scatter(x, y, c='green', marker='^', s=100)
    
#     # Boundary square centered at tree
...
#     radius=1.3/2,    # radius = diameter/2
#     edgecolor='blue',
...
# plt.xlabel("X (up)")
# plt.ylabel("Y (left)")
# plt.title("Tree Placement with Boundaries (rotated 90° about Z)")
# plt.show()
